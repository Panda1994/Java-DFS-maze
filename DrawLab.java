       ...
       for (;;) {
	       ...
	       lab[row][i] = line.charAt(i);
	         switch (line.charAt(i)) {
                  case 'h': drawHorWall(i,row,wallColor);
                            if ((i % 2) == 0) ++col; break;
                  case 'v': drawVertWall(i,row,wallColor); 
                            if ((i % 2)== 0) ++col; break;
                  case 'H': drawHorWall(i,row,thickWallColor);
                  			if ((i % 2) == 0) ++col; break;
                  case 'V': drawVertWall(i,row,thickWallColor); 
                  			if ((i % 2)== 0) ++col; break;
                  case 'm': drawHorMetal(i,row);
        					if ((i % 2) == 0) ++col; break;
                  case 'M': drawVertMetal(i,row); 
        					if ((i % 2)== 0) ++col; break;
                  case 'b': drawStart(i,row); 
		                    ++col; break;
